...
# to the gold that the Avatar is carrying.
    ...
    def find_gold(self, amount):
        self.Gold_in_bag=self.Gold_in_bag+amount
...
# of gold that the Avatar has buried.
    ...
    def bury_gold(self, amount):
        self.Gold_in_bag=self.Gold_in_bag-amount
        self.Buried_gold=self.Buried_gold+amount
...
# in the Avatar's bag by 10%.
    ...
    def sprinkled_with_fairy_dust(self):
        self.Gold_in_bag=self.Gold_in_bag+(0.1*self.Gold_in_bag)
...
# of gold carried (in bag) and the amount of gold buried (in the ground).
    ...
    def __str__(self):
        return self.Name+" with hair color "+self.Hair_color+" has "+ str(self.Gold_in_bag)+" in bag and "+str(self.Buried_gold)+" gold is buried"
