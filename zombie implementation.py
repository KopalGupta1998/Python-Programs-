...
class Apocalypse(poc_grid.Grid):
    ...
    def move_humans(self, zombie_distance_field):
        ...
        for index in range(len(self._human_list)):
            ...
            for neighbor in neighbors:
                neigh_dis=zombie_distance_field[neighbor[0]][neighbor[1]]
                if neigh_dis>best_dis and self.is_empty(neighbor[0],neighbor[1]):
                    best_dis=neigh_dis
                    best_pos=neighbor
    ...
    def move_zombies(self, human_distance_field):
        ...
        for index in range(len(self._zombie_list)):
            ...
            for neighbor in neighbors:
                neigh_dis=human_distance_field[neighbor[0]][neighbor[1]]
                if neigh_dis<best_dis and self.is_empty(neighbor[0],neighbor[1]):
                    best_dis=neigh_dis
                    best_pos=neighbor
